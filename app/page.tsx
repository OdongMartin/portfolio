  ...
  return (
    <>
      ...
      <div className='md:hidden'>
        ...
        <div className='flex'>
          <div className=' bg-gray-700 border-2 border-red-600 h-[93vh] w-[20vw]' ></div>
          <div className=' bg-gray-700 border-2 border-red-600 h-[90vh] w-[60vw]'>
            <div className=' bg-gray-700 border-2 border-red-600 h-[10vh] w-[60vw]' >
                          {/* top of elevator sjpould have floor */}
            </div>
            <div className=' bg-gray-700 border-2 border-blue-600 h-[80vh] w-[60vw]'>
              {/* content  */}
              {/* Home Floor */}
            <div className="h-screen w-screen" style={{zIndex: 2}}>
              <div id="home" className={`floor ${currentFloor === 0 ? 'active' : ''} h-full  text-white `} >
          ...
          <div className=' bg-gray-700 border-2 border-red-600 h-[93vh] w-[20vw]' >
